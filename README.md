...
Chrome extension for bulk actions on liked media and files in Grok.
...
1. Open `https://grok.com/imagine/*` for post actions or `https://grok.com/files` for file deletion
